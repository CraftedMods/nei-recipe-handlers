...
public class RecipeHandlerRendererUtilsImpl implements RecipeHandlerRendererUtils
{
        ...
        int direction)
    {
        ...
        {
            case 0:
                drawTexturedRectangle (x, y, textureX, textureY, var, height);
                break;
            case 1:
                drawTexturedRectangle (x, y, textureX, textureY, width, var);
                break;
            case 2:
                drawTexturedRectangle (x + width - var, y, textureX + width - var, textureY, var, height);
                break;
            case 3:
                drawTexturedRectangle (x, y + height - var, textureX, textureY + height - var, width, var);
        }
