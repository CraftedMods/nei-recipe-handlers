...
/**
 * The recipe handler configuration allows a recipe handler to load and store
 * configuration data in the configuration file of the provider. Each recipe
 * handler gets it's own entry in there.
 *
 * @author CraftedMods
 */
public interface RecipeHandlerConfiguration
{
    ...
    /**
     * If false, the recipe handler was disabled via the configuration file, if
     * true, not
     *
