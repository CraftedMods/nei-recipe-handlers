...
public interface RecipeHandlerUtils
{
    ...
    /**
     * Reads an item stack list from a tag of the specified compound with the
     * specified name.
     *
     * @param compound
     *            The tag compound
    ...
    /**
     * Writes the provided item stack list to a tag in the specified compound with
     * the specified name
     *
     * @param compound
     *            The tag compound
     ...
     * Instead of the item name it's registry name will be saved - this allows more
     * compatibility.
     *
     * @param stack
     ...
     *
     * @param compound
     *            The compound which contains the saved stack data
