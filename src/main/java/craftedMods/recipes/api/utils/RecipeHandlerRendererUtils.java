...
public interface RecipeHandlerRendererUtils
{
    ...
    /**
     * Draws a rectangle from P(x|y) to Q(x+width|y+height) with a gradient color
    ...
    /**
     * Draws a rectangle from P(x|y) to Q(x+width|y+height) with a part of the
     * current bound texture from R(textureX|textureY) to
    ...
    /**
     * Draws text centered around P(x|y) with the specified color and optionally a
     * text shadow.
     *
     * @param text
     *            The text
    ...
    /**
     * Draws a progress bar from P(x|y) to Q(x+width|y+height) with a part of the
     * current bound texture from R(textureX|textureY) to
     * S(textureX+width|textureHeight+height) by the provided completion (100% for
     * the whole bar) from the provided direction.
     *
     * @param x
     *            The x origin
     * @param y
     ...
     */
    public void drawProgressBar (int x, int y, int textureX, int textureY, int width, int height, float completion,
        EnumProgressBarDirection direction);
