...
/**
 * A recipe handler renderer draws the GUI of a recipe handler. It's needed if
 * you need more than the default texture - to example text, animated progress
 * bars and so on. The rendering can be done with the functions in
 * {@link craftedMods.recipes.api.utils.RecipeHandlerRendererUtils}}
 *
 * @author CraftedMods
 * @param <T>
...
public interface RecipeHandlerRenderer<T extends RecipeHandler<U>, U extends Recipe>
{
    ...
    /**
     * The default GUI texture. If a recipe handler has no renderer, this texture
     * will be rendered as it's background.
     */
