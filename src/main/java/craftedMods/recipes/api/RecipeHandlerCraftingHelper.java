...
/**
 * The crafting helper coordinates the recipe overlay and the automatic
 * placement of recipe ingredients in the GUI of the supported devices (to
...
public interface RecipeHandlerCraftingHelper<T extends Recipe>
{
    ...
    /**
     * Returns a set of GUI classes which are supported for the overlay rendering or
     * item stack placing. These GUI classes are the GUI classes of the
     ...
     * The recipe handler displays a set of recipe item slots in NEI. To choose the
     * right slots of the device's GUI, their position has to match the position of
     * the slots in this GUI. Usually they've to be moved for this.
     *
     * @param guiClass
    ...
    /**
     * Returns whether an item stack in the inventory of the player matches a recipe
     * ingredient
     *
     * @param stack1
     *            Stack one
